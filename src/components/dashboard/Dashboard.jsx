...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        const fetchRepositories = async () => {
           try {
            const response = await fetch(`http://13.233.253.136/repo/user/${userId}`);
        ...
        const fetchSuggestedRepositories = async () => {
           try {
            const response = await fetch(`http://13.233.253.136/repo/all`);
     ...
     <section id="dashboard">
        ...
        <aside>
            ...
            <ul>
                ...
                <li><p>Developer Meet - Dec 25</p></li>
                <li><p>React Summit - Jan 15</p></li>
            </ul>
        </aside>
    </section>
    </>
